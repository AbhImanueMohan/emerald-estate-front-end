    ...
    <div className="p-3 max-w-lg  mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 ">
        ...
        <img onClick ={()=>fileRef.current.click()} src = { formData.avatar || currentUser.avatar}
         alt="profile"  className="rounded-full h-24 w-24 
        ...
        <p className="text-sm self-center">
          ...
          filePerc > 0 && filePerc <100 ? (
            ...
            :
             filePerc === 100 ? (
              <span className="text-green-700">Successfully Uploaded the image</span> )
              :
              ""   
          
         }
        </p>
        <input onChange={handleChange} type="text" placeholder="username"  defaultValue={currentUser.username}
         className="border p-3 rounded-lg" id="username"/>
        <input onChange={handleChange}  type="text" placeholder="email"  defaultValue={currentUser.email}
