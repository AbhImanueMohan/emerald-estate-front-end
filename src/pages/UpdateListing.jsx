...
export default function UpdateListing() {
  ...
  const [formData, setFormData] = useState({
    ...
    bathrooms: 1,
    regularPrice: 100,
    discountPrice: 0, // Corrected the property name here
    offer: false,
    parking: false,
    furnished: false,
  });
...
<div className="flex gap-6 flex-wrap">
      ...
      <div className="flex flex-wrap gap-6">
        ...
        <div className="flex items-center gap-2">
          <input type="number" id="regularPrice" min="10000" max="100000000" 
          required className="p-3 border border-gray-300 rounded-lg"
        ...
        <div className="flex items-center gap-2">
        <input type="number" id="discountPrice" min="0" max="500000" 
        required className="p-3 border border-gray-300 rounded-lg"
        onChange={handleChange} value={formData.discounPrice}/>
        <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col flex-1 gap-4">
        ...
        <span className="font-norma text-gray-600 ml-2"> The First image will be the cover (max-6)</span>
        </p>
        <div className=" flex gap-4">
          <input onChange={(e)=>setFiles(e.target.files)} className="p-3 
          border border-gray-300 rounded w-full" type="file"  
          ...
          <button type="button" disabled={uploading} onClick={handleImageSubmit}
           ...
           hover:shadow-lg disabled:placeholder-opacity-80"
        ...
        <p className="text-red-700 text-sm ">{imageUploadError && imageUploadError}</p>
        {
          formData.imageUrls.length >0 && formData.imageUrls.map((url)=>(
            <div  key={url} className="flex justify-between p-3 border items-center">
              ...
              className="p-3 text-red-700 rounded-lg uppercase hover:placeholder-opacity-75">
                Delete</button>
