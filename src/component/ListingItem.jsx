...
export default function ListingItem({listing}) {
  return (
    <div className="p-1">
     ...
     transition-shadow overflow-hidden rounded-lg sm:w-[270px] "  >
    <Link to={`/listing/${listing._id}`}>
        <img src={listing.imageUrls[0] }
         alt="listing cover" className="h-[220px] 
...
<div className="p-3 flex flex-col gap-2 w-full ">
        ...
        <p className="text-sm text-gray-600 line-clamp-2  text-slate-700 "> {listing.description}</p>
